...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden py-12 sm:py-16 md:py-20 lg:py-24">
      {/* Hero Spotlights */}
      ...
      <div className="text-center z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-5xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-7 px-2 sm:px-4 md:px-6">
      ...
      <div
        className="z-50 absolute bottom-4 sm:bottom-5 md:bottom-6 lg:bottom-8 xl:bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer"
        onClick={handleClick}
